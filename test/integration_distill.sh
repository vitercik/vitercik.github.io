...
distill_fixture="_posts/2000-01-03-distill-integration-${fixture_suffix}.md"
...
date: 2000-01-03
permalink: /integration-test/distill/
...
distill_page="${tmp_site}/integration-test/distill/index.html"
