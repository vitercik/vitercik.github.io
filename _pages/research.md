...
## 1. Learning-theoretic foundations of algorithm design
...
- “How Much Data Is Sufficient to Learn High-performing Algorithms?” (Balcan et al., JACM’24, STOC’21) provides broadly applicable generalization guarantees for configuring algorithms with ML.
- “Algorithms with Calibrated Machine Learning Predictions” (Shen et al., ICML’25) examines how algorithms can adapt to uncertainty about their inputs, characterized via calibration.

## 2. Trustworthy artificial intelligence (AI) for discrete optimization
...
- AI is increasingly used to customize the optimization model provided to a solver, since a problem can be formulated in many ways, some faster to solve than others. “EquivaMap” (Zhai et al., ICML’25) develops methods to check if the customized model still faithfully represents the original problem.

## 3. Algorithmic reasoning in AI systems
...
- “Leveraging Reviews: Learning to Price with Buyer and Seller Uncertainty” (Guo et al., OR’26, EC’23) develops pricing mechanisms when both sides of a market are learning from reviews: buyers use reviews to learn their values while the seller learns about demand.
